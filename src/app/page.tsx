				...
				<div className="container grid items-center justify-center gap-4 px-4 text-center md:px-6 lg:gap-10">
					...
					<div className="container px-5 mx-auto flex flex-wrap">
						<div className="flex relative pt-10 pb-20 sm:items-center md:w-2/3 mx-auto">
							...
							<div className="flex-shrink-0 w-6 h-6 rounded-full mt-10 sm:mt-0 inline-flex items-center justify-center bg-zinc-500 text-white relative z-10 title-font text-sm ">
								1
							</div>
							<div className="flex-grow md:pl-8 pl-6 flex sm:items-center items-start flex-col sm:flex-row">
								<div className="flex-shrink-0 w-24 h-24 bg-indigo-100 text-indigo-950 rounded-full inline-flex items-center justify-center">
									Dev
								</div>
								<div className="flex-grow sm:pl-6 mt-6 sm:mt-0">
									<h2 className="font-medium title-font text-zinc-300 mb-1 text-3xl tracking-tight">
										Auto Shop Insights - Freelance
									</h2>
									<p className="leading-relaxed">
										Lorem ipsum dolor sit amet, consectetur
										adipisicing elit. Voluptate, repellendus
										ratione vel ipsam ab cumque in, optio
										minus, nostrum quo similique voluptatem
										non odit nisi? Illum unde veritatis
